...
function checkIfOutOfGrid(extra) {
    ...
    for(i=0;i<64;i++){
        if(tdChild[i].children.length === 1){
            if(i > -1 && i <8){
                 index=0;
                 if(trRow[index].rowIndex === 0 && tdChild[i].cellIndex === 0){
                    if(direction === 2 || direction === 1){
                        break;  
                    }
                        return true;
                 }
                 else if(trRow[index].rowIndex === 0 && tdChild[i].cellIndex === 7){
                ...
                index=3;
                if(trRow[index].rowIndex === index && tdChild[i].cellIndex === 0){
                    if(direction === 2 || direction === 0){
                        break;
                    }
                    return true;
                ...
                if(trRow[index].rowIndex === index && tdChild[i].cellIndex === 0 ){
                    ...
                    return true;
                }else if(trRow[index].rowIndex === index && tdChild[i].cellIndex === 7 ){
